...
import '../future_calls/reminder_execution_call.dart' as _i3;
...
class FutureCalls extends _i1.FutureCallDispatch<_FutureCallRef> {
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'ReminderExecutionCallInvokeFutureCall':
          ReminderExecutionCallInvokeFutureCall(),
    };
...
class _FutureCallRef {
  ...
  late final reminderExecutionCall = _ReminderExecutionCallFutureCallDispatcher(
    _invokeFutureCall,
  );
}

class _ReminderExecutionCallFutureCallDispatcher {
  _ReminderExecutionCallFutureCallDispatcher(this._invokeFutureCall);
...
class ReminderExecutionCallInvokeFutureCall
  ...
  _i2.Future<void> invoke(
    ...
    await _i3.ReminderExecutionCall().invoke(
      session,
      object,
    );
  }
