...
--
-- Class ButlerReminder as table butler_reminder
--
CREATE TABLE "butler_reminder" (
    "id" bigserial PRIMARY KEY,
...
CREATE TABLE "household" (
    ...
    "isFocusActive" boolean NOT NULL DEFAULT false,
    "focusEndTime" timestamp without time zone,
    "focusMode" text,
    "focusStartedBy" bigint
);
...
--
-- Class SharedRoutine as table shared_routine
--
...
CREATE TABLE "user_profile" (
    ...
    "hydrationGoal" bigint NOT NULL DEFAULT 8,
    "hydrationCount" bigint NOT NULL DEFAULT 0,
    "hydrationDate" text,
    "hydrationReminder" boolean NOT NULL DEFAULT false,
    "hydrationHistory" text,
    "focusCompleted" bigint NOT NULL DEFAULT 0,
    "focusGivenUp" bigint NOT NULL DEFAULT 0,
    "hydrationInterval" bigint NOT NULL DEFAULT 60,
    "journalReminder" boolean NOT NULL DEFAULT false,
    "journalInterval" bigint NOT NULL DEFAULT 24,
    "bookReminder" boolean NOT NULL DEFAULT false,
    "bookInterval" bigint NOT NULL DEFAULT 24,
    "focusModeDuration" bigint NOT NULL DEFAULT 25
);

-- Indexes
CREATE UNIQUE INDEX "userInfoId_idx" ON "user_profile" USING btree ("userInfoId");
